...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\Student\AppData\Local\Tesseract-OCR\tesseract.exe' #Deschidem tesseract
img = cv2.imread(r'C:\Users\Student\Pictures\AS_3421\nrinm.png') #Poza pe care o alegem
